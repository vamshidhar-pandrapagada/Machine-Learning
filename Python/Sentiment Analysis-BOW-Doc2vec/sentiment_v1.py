...
def main(method, input_type):
    ...
    if method == "nn":
        train_pos_vec, train_neg_vec, test_pos_vec, test_neg_vec = feature_vecs_DOC(train_pos, train_neg, test_pos, test_neg)
        build_models_Neuralnet(train_pos_vec, train_neg_vec, test_pos_vec, test_neg_vec)
...
def build_models_Neuralnet(train_pos_vec, train_neg_vec, test_pos_vec, test_neg_vec):
    ...
    cmatrix = confusion_matrix(test_Y, test_predictions)
    accuracy = (cmatrix[0][0] + cmatrix[1][1])/len(test_predictions)
    tp  = cmatrix[0][0]
    fn =  cmatrix[0][1]
    fp =  cmatrix[1][0]
    tn =  cmatrix[1][1]
